        ...
        <div className='first'>
            <div className='start'>
                ...
                <p>
                    <span>
                        {' '}
                        To begin, make sure you have a MetaMask wallet installed
                        on your browser, or use one of the wallets supported by
                        Wallet Connect (we recommend Trust Wallet).
                    </span>{' '}
                    <span>
        ...
        <div className='second'>
            ...
            <p>
                <span>
                    ...
                    “Connect Wallet” and select the appropriate option. For
            ...
            <div className='grid'>
                <div className='item'>
                    ...
                    <p>
                        ...
                        &nbsp; this will allow you to purchase ETH that will be
                        sent to your wallet. You will then be able to use this
                        ETH to purchase Doge Rush. Visit&nbsp;
                        <a
                            style={{
                                color: 'rgb(15, 218, 244)',
                                display: 'inline-block',
                        ...
                        &nbsp; to begin and follow the on screen steps. We
                        recommend purchasing a minimum of $20 worth of ETH to
                        cover the minimum Doge Rush purchase.
                    </p>
                </div>
                {info.map((item, ind) => {
                    return (
    ...
    return (
        <div className='third'>
            <div className='start'>
                ...
                <p>
                    <span>
                        Once the presale has concluded, you will be able to
                        claim your Doge Rush tokens. We will release details
                        closer to the time, however you will need to visit the
                        main site: {' '}
                        <a
